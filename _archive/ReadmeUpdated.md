[size=6][b][color=red]⚠️ IMPORTANT NOTICE ⚠️[/color][/b][/size]  
[size=5][b][color=red]THIS VERSION OF COMBAT METRONOME WILL RECEIVE ITS FINAL UPDATE![/color][/b][/size]  
[size=4][b]All future updates will only be available on the original version:[/b][/size]  
[url=https://www.esoui.com/downloads/info2373-CombatMetronomeGCDTracker.html][size=4][color=orange]Combat Metronome (GCD Tracker)[/color][/size][/url]  
[size=3]This change is intended to reduce unnecessary clicks for website operators and simplify maintenance for me.[/size]
